    ...
    <div class="w-full max-w-md mx-auto p-6 rounded-3xl bg-[var(--glass-bg)] backdrop-blur-xl border border-[var(--glass-border)] soft-card shadow-lg">
        ...
        <form onsubmit="login(event)" class="space-y-6">
            <div>
                ...
                <input type="email" name="email" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:border-blue-500 focus:outline-none bg-white/80" placeholder="contoh@email.com" required>
            </div>
            <div>
                <label class="block mb-2 text-gray-700">Kata Sandi</label>
                <div class="relative">
                    <input type="password" name="password" id="password" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:border-blue-500 focus:outline-none bg-white/80 pr-10" placeholder="Masukkan kata sandi" required>
